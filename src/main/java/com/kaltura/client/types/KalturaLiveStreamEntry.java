...
public class KalturaLiveStreamEntry extends KalturaMediaEntry {
    ...
    public String externalStreamId;
    ...
    public KalturaLiveStreamEntry(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("offlineMessage")) {
                ...
                continue;
            } else if (nodeName.equals("externalStreamId")) {
                this.externalStreamId = ParseUtils.parseString(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("externalStreamId", this.externalStreamId);
