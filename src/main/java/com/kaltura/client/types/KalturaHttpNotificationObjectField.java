...
public class KalturaHttpNotificationObjectField extends KalturaEvalStringField {
    ...
    public KalturaHttpNotificationObjectField() {
    }

    public KalturaHttpNotificationObjectField(Element node) throws KalturaApiException {
        super(node);
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaHttpNotificationObjectField");
