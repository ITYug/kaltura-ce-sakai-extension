...
public class KalturaSystemPartnerConfiguration extends KalturaObjectBase {
    ...
    public ArrayList<KalturaString> disabledDeliveryTypes;
    ...
    public KalturaSystemPartnerConfiguration(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("disabledDeliveryTypes")) {
                this.disabledDeliveryTypes = ParseUtils.parseArray(KalturaString.class, aNode);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("disabledDeliveryTypes", this.disabledDeliveryTypes);
